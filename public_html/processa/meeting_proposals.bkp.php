<?php
	...
	$emailHtml = '<div style="width:700px;">
				...
				Dear '.$convidado['first_name'].' '.$convidado['last_name'].', '.$solicitante['first_name'].' '.$solicitante['last_name'].' sent you a meeting request. <br /><br />
	...
	$emailHtml = '<div style="width:700px;">
				<img src="http://www.riw-sv.com/img/email-header.gif" />
				<div style="margin-left:50px;"><br />
					Dear '.$solicitante['first_name'].' '.$solicitante['last_name'].', You sent a meeting request to '.$convidado['first_name'].' '.$convidado['last_name'].'. 
