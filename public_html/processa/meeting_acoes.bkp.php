<?php
	...
	$emailHtml = '<div style="width:700px;">
				...
				<div style="margin-left:50px;"><br />
				 	Dear '.$solicitante['first_name'].' '.$solicitante['last_name'].'. '.$convidado['first_name'].' '.$convidado['last_name'].' is not available at the requested meeting time. For details please visit your <a href="http://riw-sv.com/meetings">Meeting Dashboard</a>					
	...
	if($acao=='acept'){
		...
		//$id_mesa = 0;
		if(!($id_mesa>0)){
			header('Location: ../instantes?msg='.urlencode('Todoas as mensas estão reservadas para este horario. Escolha outro.'));exit;
		}
	...
	$emailHtml = '<div style="width:700px;">
				...
				<div style="margin-left:50px;"><br />
					...
					Dear '.$convidado['first_name'].' '.$convidado['last_name'].', You are confirmed to meet '.$solicitante['first_name'].' '.$solicitante['last_name'].', Thr '.$convite['day'].' '.$convite['instante'].' on '.$convite['table'].' at the Russian Innovation Week 2012. For details please visit your <a href="http://riw-sv.com/meetings">Meeting Dashboard</a>
	...
	$emailHtml = '<div style="width:700px;">
				<img src="http://www.riw-sv.com/img/email-header.gif" />
				<div style="margin-left:50px;"><br />
				 	Dear '.$solicitante['first_name'].' '.$solicitante['last_name'].', You are confirmed to meet '.$convidado['first_name'].' '.$convidado['last_name'].' Thr '.$convite['day'].' on '.$convite['table'].' at the Russian Innovation Week 2012. For details please visit your <a href="http://riw-sv.com/meetings">Meeting Dashboard</a>					
