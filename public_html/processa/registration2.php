<?php
	...
	if(strlen($erro)>0){
		header('Location: ..'.$origem.'/?erro='.base64_encode('Please fill up the mandatory fields.:'.$erro));exit;
	}	
	...
	header('Location: ..'.$origem.'/?suc='.base64_encode('Thank you. Your request has been sent!'));exit;
