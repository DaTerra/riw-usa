...
<div id="content-container" class="right_column_of2 registration bg_red">
	<div id="form_information">
        <form action="../processa/Information.php" method="post" enctype="multipart/form-data">
        	...
        	<div class="form_item"><label>Success stories:</label><input type="text" name="success_stories" value="" /><span>(Links to recent articles about your company, any recent partnerships, etc)</span></div>
            ...
            <h4>Media Upload:</h4>
        	<div class="form_item"><label>Profile Photo:</label><input type="file" name="profile_photo" /></div>
        	<div class="form_item"><label>Company Logo:</label><input type="file" name="company_logo" /></div>
        	<div class="form_item"><label>Presentation:</label><input type="file" name="presentation_file[]" multiple="multiple" /><span style="padding-left:100px;">(PowerPoint, PDF, etc.)</span></div>
        	<div class="form_item"><label>Company videos:</label><input type="file" name="company_videos[]" multiple="multiple" /></div>
        	<div class="form_item"><label>Product photos:</label><input type="file" name="product_photos[]" multiple="multiple" /></div>
            ...
            <div style="margin-top:20px;"><button>Save</button></div>
        </form>
	</div>
</div>
