...
?>
    ...
    <tbody>
		...
		?>
        <tr>
			<td style="text-align: center;"><input <? if(!(in_array($linha['id_status'], array('2','3', 8)))) echo 'disabled="disabled"';?>  name="selected[]" value="<?=$linha[$Modulo['id_tabela']]?>" type="checkbox"></td>
