...
<div id="geral">
    ...
    <div id="menu">
		...
		<?
				...
				if($_SESSION['adm_usuario']['status_admin']==2){
                	$SQL = 'SELECT * FROM TBAAMENU WHERE id_pai=0 ORDER BY posicao ASC';
				}else{
					$SQL = 'SELECT * FROM TBAAMENU
                        JOIN TBAAUSUARIOS_PERMISSOES ON TBAAMENU.id_menu=TBAAUSUARIOS_PERMISSOES.id_menu
                        WHERE TBAAUSUARIOS_PERMISSOES.id_usuario='.$_SESSION['adm_usuario']['id_usuario'].'
                        ORDER BY TBAAMENU.posicao ASC';
				}
        ...
        ?>
            ...
            <li class="menu_principal" onmouseover="menu('sub_<?=$linha['id_menu']?>')" onmouseout="fecha('sub_<?=$linha['id_menu']?>')">
                ...
                <?
                	...
                	$SQL_sub = 'SELECT * FROM TBAAMENU WHERE id_pai='.(int)$linha['id_menu'].' ORDER BY posicao ASC';
