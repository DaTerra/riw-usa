...
<div id="geral">
    ...
    <div id="login">
        <form name="login" method="post" action="./sistema/login.php">
            <div><label for="usuario">Usuário</label><p><input id="usuario" type="text" name="usuario" /></p></div>
    ...
    <span id="voltar_site"><a title="Está perdido?" href="http://<?=DOMINIO?>">Voltar para o site</a></span>
</div>
