...
<?
	...
	if(!empty($_GET['fil_first'])){
		...
		if(!empty($_GET['fil_first'])){
			...
			$SQL .= ' AND tbinformation.company LIKE "%'.(string)$_GET['fil_company'].'%"';	
		}elseif(!empty($_GET['fil_date'])){
...
<div class="limpar"></div>
    <thead>
    	<tr>
            ...
            <td class="left"><a href="?m=<?=$Modulo['modulo']?>&amp;campo=last_name&amp;order=<?=$order?>" <? if($_GET['campo']=='company') echo' class="'.$class_order.'"';?>>Company</a></td>
    ...
    <tbody>
        <tr class="filter">
            ...
            <td><input type="text" name="fil_last" value="<?=$_GET['fil_company']?>" /></td>
...
<div id="modulo_cabecalho">
    ...
    <ul>
        ...
        <li><a class="adm_bts" target="_blank" href="/admin/modulos/submitpdf.php?id=<?=$Dados['id_info']?>">PDF</a></li>
    </ul>
</div>
    ...
    <style type="text/css">
    	#list_information{}
    	#list_information h4{ margin-bottom:10px; display:block; font-size:15px;}
		...
		.information_item_files{margin-bottom:5px; clear: both;}
		.information_item_files ul li{ height:32px; line-height:32px; margin-top:5px;}
		.information_item_files ul li img{ float:left;}
		
		#list_produtos{ }
		#list_produtos ul li{ float:left; margin-right:10px;}
    ...
    <div id="list_information">
        ...
        <div  class="information_item">
            ...
            <a target="_blank" href="../../files/information/<?=$Dados['pasta']?>/<?=$Dados['profile_photo']?>"><img src="../img.php?dim=100x80&arquivo=./files/information/<?=$Dados['pasta']?>/<?=$Dados['profile_photo']?>" /></a>
        </div>
        <br />
        ...
        <div  class="information_item_files">
            ...
            <ul>
				...
				?>
            	<li>
            		<a target="_blank" href="../../files/information/<?=$Dados['pasta']?>/<?=$linha['file']?>"><img src="./sistema/img/icones_extensoes/<?=$ext?>.png" />Download <?=$x?></a>
                </li>
                <? } }else{?>
                	<li>No results</li>
                <? }?>
