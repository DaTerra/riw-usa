...
?>
    ...
    <tbody>
		...
		?>
        <tr>
			<td style="text-align: center;"><input <? if(!(in_array($linha['id_status'], array('2','3')))) echo 'disabled="disabled"';?>  name="selected[]" value="<?=$linha[$Modulo['id_tabela']]?>" type="checkbox"></td>
        ...
        <? }}else{?>
        <tr><td class="center" colspan="8">Sem resultados!</td></tr>
        <? }?>
    </tbody>
</table>
