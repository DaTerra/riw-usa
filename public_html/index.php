...
<meta name="author" content="DaTerra Web - www.daterraweb.com - you@daterraweb.com">
<? //Favicon?>
...
<? if($url['0']=='agenda') echo 'id="menu_ativo"';?>


<? if($url['0']=='save-the-date') echo'<title>RIW2013 - Russian Inovation Week 2013</title>'; 
		else echo '<title>RIW2012 - Russian Inovation Week 2012</title>';?>
...
<? if($url['0']=='') { ?>
<meta http-equiv="REFRESH" content="0;url=http://riw-sv.com/save-the-date">
<? } ?>
</head>
...
<? if($url['0']=='save-the-date') { ?>
<style>
#main_logo h1 a {
    background: url("../img/RIW-2013.png") repeat scroll 0 0 transparent;
    display: block;
    height: 245px;
    text-indent: -9999px;
    width: 142px;
...
<? } ?>
            <h1><a <? if($url['0']!='save-the-date') { ?> href="/" <? } ?>>Russian Inovation Week 2012 - October 25-26 - USA</a></h1>                
	...
	#menu_ativo, #sub_ativo{ color:red;}
        ...
        <div id="main_menu_content">    
          ...
          <div id="site_menu">
          	...
          	<ul>
			<? if($url['0']!='save-the-date') { ?>
            	<li style="margin-left:40px;" class="meu_principal" ><a <? if($url['0']=='agenda') echo 'id="menu_ativo"';?> href="/agenda/Day-1-Thu-Oct-25">Agenda</a></li>
                ...
                <li class="meu_principal"><a <? if($url['0']=='travel_info') echo 'id="menu_ativo"';?> href="/travel_info">Travel</a></li>
                <li class="meu_principal"><a <? if($url['0']=='gallery') echo 'id="menu_ativo"';?> href="/gallery">Gallery</a></li>
            <? } else {?>
            	<li style="margin-left:615px;" class="meu_principal"><a href="/home">Visit RIW 2012</a></li>
            <? } ?>    
            </ul>
        ...
        <div id="main_content">    
            ...
            <div class="left_column_of2">
				...
				<? if($url['0']=='home'){?>
					<a href="/save-the-date"><div style="margin:8px 0 0 1px; position:absolute; z-index:50; width:142px;height:245px; float:left; background:url(img/RIW-2013.png) no-repeat center #FCC; border-radius:20px 0px 20px 0px; border:1px solid #666; padding:10px;"></div></a>
				<? }?>
        ...
        <div id="footer"> 
            ...
            <div id="mf_copyright">    
                ...
                <p>&copy; 201<? if($url['0']!='save-the-date'){?>2<? } else {?>3<? } ?> RIW<br/>Russian Innovation Week</p>                    
            ...
            <div id="mf_contact">    
                ...
                <a href="mailto:you@daterraweb.com">you@daterraweb.com</a>              
