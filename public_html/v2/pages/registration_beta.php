<div id="content-container" class="right_column_of2 registration bg_red">
					...
					<?
						...
						if(strlen($_GET['erro'])>0){
							echo '<script type="text/javascript"> alert("'.base64_decode($_GET['erro']).'");</script>';	
							
						}elseif($_GET['suc']){
							echo '<script type="text/javascript"> alert("'.base64_decode($_GET['suc']).'");</script>';	
						}
						
					?>
					
					<form action="../processa/registration.php" method="post">
