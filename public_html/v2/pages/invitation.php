                            ...
                            <div id="content-container-packages-content" style="display:none">                            
                                ...
                                <div class="packages-description_block1">
									...
									<ul class="checkbox_1line_list">
                                        ...
                                        <li>
                                        	<input <? if($linha['preferences']) echo 'onclick="desabilita(this)" class="events_chec"';?> type="checkbox" name="id_event" value="<?=$linha['id_event']?>" />
                            ...
                            <div id="content-container-packages-content" style="display:none">                            
                                ...
                                <div class="packages-description_block2">
									...
									<ul class="radiobtn_1line">
                                		...
                                		<li><input type="radio" name="entree" value="Poultry" /><label class="label_radio"> Poultry</label></li>

                                        <li><input type="radio" name="entree" value="Beef"/><label class="label_radio"> Beef</label></li>

                                        <li><input type="radio" name="entree" value="Fish"/><label class="label_radio"> Fish</label></li>
                                    ...
                                    <div class="clear"></div>
 									...
 									<ul class="center">
                                		...
                                		<li><input id="alergy_true" onclick="toggleStatus()" type="radio" name="allergy" value="1" /><label class="label_radio"> Yes</label></li>

                                        <li><input onclick="toggleStatus()" type="radio" name="allergy" value="0"/><label class="label_radio"> No</label></li>	
                                ...
                                <div class="packages-description">
                                    ...
                                    <ul class="block3">
										...
										<?
											...
											while($linha = $DB->lista($consulta)){
                                        ?>
                                        <li><input type="checkbox" name="id_interest" value="<?=$linha['id_interest']?>" /><label class="label_check"><?=$linha['interest']?></label></li>
										<? }?>					
                            ...
                            <div id="content-container-packages-content" style="display:block">                            
                                ...
                                <div class="packages-description">
                                    ...
                                    <ul class="center">
                                		...
                                		<li><input type="radio" name="email_updates" value="1" /><label class="label_radio"> Yes</label></li>
                                    ...
                                    <ul class="center">
                                		...
                                		<li><input type="radio" name="networking" value="1" /><label class="label_radio"> Yes</label></li>
                                    ...
                                    <ul class="center">
                                        ...
                                        <li><label class="label_radio"><input type="radio" name="public_profile" value="1" /> Yes</label></li>
                            ...
                            <div id="content-container-packages-content" style="display:none">                             
                                ...
                                <div class="packages-description">
                                    ...
                                    <p>What industry is your guest associated with? (Check all that apply)</p>    
                                        ...
                                        <li><input type="checkbox" name="id_typeIndustry" value="<?=$linha['id_typeindustry']?>" /><label class="label_check"><?=$linha['id_typeindustry']?></label></li>
										<? }?>					
                                            </ul>  
