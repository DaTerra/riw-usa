...
<!--Adobe Edge Runtime-->
    ...
    <style>
        .edgeLoad-EDGE-69715667 { visibility:hidden; }
    </style>
...
<body>
    ...
    <div id="wrapper">  
            <div id="Stage" class="EDGE-69715667 edgeLoad-EDGE-69715667">
        ...
        <div id="main_menu">
        	...
        	<ul>		           	 
            	...
            	<li class="mm_home"><a class="dtr_pro_mediumRg <? if($url['0'] == 'home' || $url['0'] == '') echo 'mm_home_on';?>" href="/">Home</a></li>                

                <li class="mm_agenda"><a class="<? if($url['0'] == 'agenda') echo 'mm_agenda_on';?>" href="/agenda">Agenda</a></li>                               

                <li class="mm_registration"><a class="<? if($url['0'] == 'registration') echo 'mm_registration_on'; ?>" href="/registration">Registration</a></li>

                <li class="mm_organizers_and_partners"><a class="<? if($url['0'] == 'organizers_and_partners') echo 'mm_organizers_and_partners_on'; ?>" href="/organizers_and_partners">Organizers and Partners</a></li>

                <li class="mm_speakers_and_participants"><a class="<? if($url['0'] == 'speakers_and_participants') echo 'mm_speakers_and_participants_on'; ?>" href="/speakers_and_participants">Speakers and Participants</a></li>

                <li class="mm_media"><a class="<? if($url['0'] == 'media') echo 'mm_media_on'; ?>" href="/media">Media</a></li>

                <li class="mm_travel_info"><a class="<? if($url['0'] == 'travel_info') echo 'mm_travel_info_on'; ?>" href="/travel_info">Travel Info</a></li>
