<div  class="right_column_of2">
	...
	?>
	<!-- -->
    <div onmouseover="display('speker<?=$linha['id_company']?>', 'mostra')" onmouseout="display('speker<?=$linha['id_company']?>', 'esconde')" style="position:relative; width:209px;height:125px; float:left; margin:0 15px 25px 5px;">
    <div class="corned_min_box">
        ...
        <div class="body">
            ...
            <div class="right">
                <img src="/files/information/<?=$linha['pasta']?>/<?=$linha['company_logo']?>"/>
	...
	<div class="corned_small_box" id="speker<?=$linha['id_company']?>">
    	<div class="top"></div>
        <div class="body">
            <h3><?=$linha['titulo']?><br/>
        	<div class="left"> 
				...
				?>
                  ...
                  <? }?>  
           		...
           		<p><a href="/company/<?=$linha['id_company']?>">More</a></p>
            </div>
            <div class="right">
            	<img src="/files/information/<?=$linha['pasta']?>/<?=$linha['company_logo']?>"/>
            </div>
