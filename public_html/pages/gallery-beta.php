...
.content_index li{width:200px; height:132px; overflow:hidden; float:left; margin-left:14px; margin-bottom:10px;}
				...
				<ul>
					...
					?>
                        ...
                        <a target="_blank" href="/gallery-images/speakers/<?=$linha['picture'];?>" rel="lightbox[photogallery]" title="Russian Innovation Week 2012">
                        	<img src="/gallery-images/speakers/thumb/<?=$linha['picture'];?>" width=200>
                        </a>
                        </li>
                    <? } ?>  
                </ul>                                                 
