        ...
        <div class="body">
            <div class="content_index">
				...
				<ul>
					...
					?>
                        <li>
                        <a target="_blank" href="/gallery-images/participants/BHI_<?=$linha['picture'];?>.JPG" rel="shadowbox" title="Russian Innovation Week 2012">
				...
				<ul>
					...
					?>
                        <li>
                        <a target="_blank" href="/gallery-images/speakers/BHI_<?=$linha2['picture'];?>.JPG" rel="shadowbox" title="Russian Innovation Week 2012">
