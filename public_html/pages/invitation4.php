<div id="content-container" class="right_column_of2 registration bg_red">
				...
				?>
					...
					<form method="post" action="../processa/Invitation.php">	
                        ...
                        <div id="content-container-packages">                                                              
							...
							<div id="copiadiv">
                                    ...
                                    <p>What industry is your guest associated with? (Check all that apply)</p>    
										...
										*/?>
                                        <div id="copiaraqui"></div>
                                        
                                        		
									</div>
                                    
                                </div>                      
                                <a id="add_contact" style="text-align:center; cursor:pointer">+ Refer another Guest</a>                                      
					...
					$("#add_contact").click(function () {
						//alert('-');
						var htmlStr = $('#copiadiv').html();
						$("#copiaraqui").html('<p>----------------</p>'+htmlStr);
					});
