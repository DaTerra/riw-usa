    ...
    <div class="corned_box">
        ...
        <div class="body">
          <div style="width:660px; float:left; padding:0 20px;">
             ...
             <br/> 
             <p> Welcome to the RIW 2012 Meeting Scheduller.</p><br/>
             <p>Use your e-mail, the same used to register, and your personal key to login.</p><br/>
             <p>If you don't remember your key  <a title="" href="/keyrecover">click here</a>.</p><br/>
             <p>If you don't know don't have access to the e-mail used to register please contact <a href="mailto:registration@riw-sv.com">registration@riw-sv.com</a>.</p>             
          </div>                    
         	<div class="clear"></div>
      </div>
        <div class="clear"></div> 
